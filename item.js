...
gameState.createItemTypes = function () {
	...
	fuelCapEffect = function (ship, itemType) {
		ship.fuelTankSize += itemType.fuelCap;
					  ...
					  // WEAPONS:
    this.itemTypes = {LaserCannon:			{name: 'LaserCannon',			niceName: 'Laser Cannon',		shortName: 'Laser Cannon', imageIndex: 0, requiresTarget: true, damage: 4, ignoreShields: 'default', range: 8.0 * TILE_SIZE, effect: projectileEffect, coolDown: 4 * SECOND, equippable: true, weight: 1.0, value: 2500, dropable: true},
					  PlasmaCannon:			{name: 'PlasmaCannon',			niceName: 'Plasma Cannon',		shortName: 'Plasma Cannon', imageIndex: 1, requiresTarget: true, damage: 8, ignoreShields: 'block', range: 8.0 * TILE_SIZE, effect: projectileEffect, coolDown: 4 * SECOND, equippable: true, weight: 1.0, value: 5000, dropable: true},
					  MassDriver:			{name: 'MassDriver',			niceName: 'Mass Driver',		shortName: 'Mass Driver', imageIndex: 2, requiresTarget: true, damage: 5, ignoreShields: 'pass', range: 8.0 * TILE_SIZE, effect: projectileEffect, coolDown: 4 * SECOND, equippable: true, weight: 1.0, value: 5000, dropable: true},
					  MissileLauncher:		{name: 'MissileLauncher',		niceName: 'Missile Launcher',	shortName: 'Missile Launcher', imageIndex: 3, requiresTarget: true, damage: 6, ignoreShields: 'pass', range: 8.0 * TILE_SIZE, effect: projectileEffect, coolDown: 12 * SECOND, equippable: true, weight: 1.0, value: 5000, dropable: true},
					  ShieldRecharger:		{name: 'ShieldRecharger',		niceName: 'Shield Recharger',	shortName: 'Shield Recharger', imageIndex: 4, requiresTarget: false, equippable: true, effect: shieldRechargeEffect, coolDown: 20 * SECOND, weight: 1.0, value: 5000, dropable: true},

					  AdvancedLaserCannon:			{name: 'AdvancedLaserCannon',			niceName: 'Advanced Laser Cannon',		shortName: 'Adv L-Cannon', imageIndex: 5, requiresTarget: true, damage: 6, ignoreShields: 'default', range: 8.0 * TILE_SIZE, effect: projectileEffect, coolDown: 4 * SECOND, equippable: true, weight: 1.0, value: 6000, dropable: true},
					  AdvancedPlasmaCannon:			{name: 'AdvancedPlasmaCannon',			niceName: 'Advanced Plasma Cannon',		shortName: 'Adv P-Cannon', imageIndex: 6, requiresTarget: true, damage: 12, ignoreShields: 'block', range: 8.0 * TILE_SIZE, effect: projectileEffect, coolDown: 4 * SECOND, equippable: true, weight: 1.0, value: 12000, dropable: true},
					  AdvancedMassDriver:			{name: 'AdvancedMassDriver',			niceName: 'Advanced Mass Driver',		shortName: 'Adv Mass Driver', imageIndex: 7, requiresTarget: true, damage: 8, ignoreShields: 'pass', range: 8.0 * TILE_SIZE, effect: projectileEffect, coolDown: 4 * SECOND, equippable: true, weight: 1.0, value: 12000, dropable: true},
					  AdvancedMissileLauncher:		{name: 'AdvancedMissileLauncher',		niceName: 'Advanced Missile Launcher',	shortName: 'Adv M-Launcher', imageIndex: 8, requiresTarget: true, damage: 9, ignoreShields: 'pass', range: 8.0 * TILE_SIZE, effect: projectileEffect, coolDown: 12 * SECOND, equippable: true, weight: 1.0, value: 12000, dropable: true},
					  AdvancedShieldRecharger:		{name: 'AdvancedShieldRecharger',		niceName: 'Advanced Shield Recharger',	shortName: 'Adv S-Recharger', imageIndex: 9, requiresTarget: false, equippable: true, effect: shieldRechargeEffect, coolDown: 12 * SECOND, weight: 1.0, value: 12000, dropable: true},

					  // MONSTER WEAPONS:
					  LaserBeam:			{name: 'LaserBeam',				niceName: 'Laser Beam',			imageIndex: 0, requiresTarget: true, damage: 1, ignoreShields: 'default', range: 8.0 * TILE_SIZE, effect: beamEffect, coolDown: 4 * SECOND, equippable: true, weight: 1.0, value: 0, dropable: true},
					  CrystalCannon:		{name: 'CrystalCannon',			niceName: 'CrystalCannon',		imageIndex: 0, requiresTarget: true, damage: 4, ignoreShields: 'default', range: 8.0 * TILE_SIZE, effect: projectileEffect, coolDown: 3 * SECOND, equippable: true, weights: 1.0, value: 0, dropable: false},
					  IceCannon:			{name: 'IceCannon',				niceName: 'Ice Cannon',			imageIndex: 0, requiresTarget: true, damage: 3, ignoreShields: 'default', range: 8.0 * TILE_SIZE, effect: projectileEffect, coolDown: 3 * SECOND, equippable: true, weight: 1.0, value: 0, dropable: false},
					  EelCannon:			{name: 'EelCannon',				niceName: 'Eel Cannon',			imageIndex: 0, requiresTarget: true, damage: 4, ignoreShields: 'default', range: 8.0 * TILE_SIZE, effect: projectileEffect, coolDown: 3 * SECOND, equippable: true, weight: 1.0, value: 0, dropable: false},
					  DroneLaser:			{name: 'DroneLaser',			niceName: 'Drone Laser',		imageIndex: 0, requiresTarget: true, damage: 2, ignoreShields: 'default', range: 8.0 * TILE_SIZE, effect: projectileEffect, coolDown: 3 * SECOND, equippable: true, weight: 1.0, value: 0, dropable: false},
