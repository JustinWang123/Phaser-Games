...
var mainMenuState = {
	...
	preload: function () {
		...
		// GAME ICONS:
        game.load.spritesheet('MapTileset', 'assets/MapTileset.png', 24, 24);
		game.load.spritesheet('ColonyTileset', 'assets/ColonyTileset.png', 70, 34);
		game.load.spritesheet('ProjectileTileset', 'assets/ProjectileTileset.png', 16, 16);
		game.load.spritesheet('ItemIcons',	'assets/ItemIcons.png', 24, 24);
        ...
        game.load.spritesheet('Button', 'assets/Button.png', 90, 17);
        game.load.image('Menu', 'assets/Menu.png');
        game.load.image('LargeTitle', 'assets/LargeTitle.png');
		game.load.image('MediumTitle', 'assets/MediumTitle.png');
        game.load.image('TextBoxTop', 'assets/TextBoxTop.png');
        game.load.image('TextBoxMid', 'assets/TextBoxMid.png');
        game.load.image('TextBoxBottom', 'assets/TextBoxBottom.png');
        game.load.spritesheet('LargeArrow', 'assets/LargeArrow.png', 12, 22);
        game.load.spritesheet('SkillSlot', 'assets/SkillSlot.png', 64, 24);
		game.load.spritesheet('SmallBarFill', 'assets/SmallBarFill.png', 1, 2);
		game.load.image('Shield', 'assets/Shield.png');
        game.load.image('WayPoint', 'assets/WayPoint.png');
		
		// OFFICE MENU:
		game.load.image('Office', 'assets/Office.png');
		game.load.image('CatalogueHighLight', 'assets/CatalogueHighLight.png');
		game.load.image('MapHighLight', 'assets/MapHighLight.png');
		game.load.image('CharacterHighLight', 'assets/CharacterHighLight.png');
		game.load.image('DoorHighLight', 'assets/DoorHighLight.png');
		game.load.image('ShipHighLight', 'assets/ShipHighLight.png');
		game.load.image('ContractSlot', 'assets/ContractSlot.png');
		game.load.image('ContractSlotSelect', 'assets/ContractSlotSelect.png');
        game.load.image('ContractBoard', 'assets/ContractBoard.png');
		
		// MAIN MENU:
		game.load.image('Title', 'assets/Title.png');
		game.load.image('SaveSlot', 'assets/SaveSlot.png');
